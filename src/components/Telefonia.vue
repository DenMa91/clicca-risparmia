<template>
    <Header></Header>
        <div class="row h-75 justify-content-around" v-if="step === 1">
            <div class="col-12 d-flex justify-content-center align-items-center">
                <h1 class="display-3 text-center">Di Cosa Hai Bisogno?</h1>
            </div>
            <div @click="selectType('voltura')" class="col-5 text-center h-25 d-flex flex-column align-items-center justify-content-center tile voltura">
                <h1>Voltura</h1>
            </div>
            <div @click="selectType('nuovo contratto')" class="col-5 text-center h-25 d-flex flex-column align-items-center justify-content-center tile cambio">
                <h1>Nuovo Contratto</h1>
            </div>
            <div @click="selectType('cambio gestore')" class="col-5 text-center h-25 mt-4 d-flex flex-column align-items-center justify-content-center tile nuovo">
                <h1>Cambio Gestore</h1>
            </div>
            <div @click="selectType('info')" class="col-5 text-center h-25 mt-4 d-flex flex-column align-items-center justify-content-center tile info">
                <h1>Info</h1>
            </div>
        </div>
        <div class="row h-75 justify-content-center align-items-center" v-if="step === 2">
            <div class="col-12 d-flex justify-content-center align-items-center">
            ...
            <div class="col-10 d-flex justify-content-center px-5">
